describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [-0.25, 27, 1, 15, 0.756];
    let bigNumbers: Array<number> = [257, 3056, 75917, 999, 100000];
  ...
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["Strings are the best", true, 87]; // set values here - the array will take any type or combo of types.
